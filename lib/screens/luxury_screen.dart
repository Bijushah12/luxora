...
class _LuxuryScreenState extends State<LuxuryScreen> {
  ...
  Future<void> loadCategoryWatches() async {
    try {
      ...
      categoryWatches = allWatches.where((w) => w.category == 'Luxury').toList();
      setState(() => isLoading = false);
    } catch (e) {
      print('Error loading Luxury watches: $e');
      setState(() => isLoading = false);
    }
  }
            ...
            ? Center(
                child: Column(
                  ...
                  children: [
                    ...
                    const Text('Luxury watches coming soon', style: TextStyle(fontSize: 20)),
