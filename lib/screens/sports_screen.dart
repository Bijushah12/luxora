...
class _SportsScreenState extends State<SportsScreen> {
  ...
  Future<void> loadCategoryWatches() async {
    try {
      ...
      categoryWatches = allWatches.where((w) => w.category == 'Sports').toList();
      setState(() => isLoading = false);
    } catch (e) {
      print('Error loading Sports watches: $e');
      setState(() => isLoading = false);
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Sports Watches'),
        actions: [
          Stack(
            children: [
              IconButton(
            ...
            ? Center(
                child: Column(
                  ...
                  children: [
                    ...
                    const Text('Sports watches coming soon', style: TextStyle(fontSize: 20)),
