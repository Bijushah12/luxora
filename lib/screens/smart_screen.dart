...
class _SmartScreenState extends State<SmartScreen> {
  ...
  Future<void> loadCategoryWatches() async {
    try {
      ...
      categoryWatches = allWatches.where((w) => w.category == 'Smart').toList();
      setState(() => isLoading = false);
    } catch (e) {
      print('Error loading Smart watches: $e');
      setState(() => isLoading = false);
    }
  }
            ...
            ? Center(
                child: Column(
                  ...
                  children: [
                    ...
                    const Text('Smart watches coming soon', style: TextStyle(fontSize: 20)),
